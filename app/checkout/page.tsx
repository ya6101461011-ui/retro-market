  ...
  if (orderNumber) return (
    <main className="page">
      ...
      <section className="successCard" aria-live="polite">
        ...
        <p>您剛剛體驗了免費購物的快樂！這是一筆展示用訂單，不會產生真實付款或商品配送。</p>
