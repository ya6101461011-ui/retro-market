      ...
      <main className="celebrationPage">
        ...
        <div className="confetti" aria-hidden="true">
          {Array.from({ length: 96 }, (_, index) => {
            ...
            const delay = (index % 24) * 0.075;
            const duration = 3.4 + ((index * 17) % 18) / 10;
            const rotation = (index * 47) % 720 - 360;
            return (
              <i
                key={index}
                style={{
